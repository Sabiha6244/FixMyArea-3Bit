...
CREATE TABLE `payments` (
  ...
  `payment_method` enum('bkash','card','cash') NOT NULL,
...
ALTER TABLE `payments`
  ...
  ADD CONSTRAINT `payments_ibfk_2` FOREIGN KEY (`provider_id`) REFERENCES `service_providers` (`user_id`) ON DELETE CASCADE;
